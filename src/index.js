...
export async function run() {
  try {
    ...
    await execShellCommand(`tmux new -d -s upterm-wrapper -x 132 -y 43 \"upterm host --server '${uptermServer}' --force-command 'tmux attach -t upterm' -- tmux new -s upterm -x 132 -y 43\"`)
    await sleep(2000)
